...
var OfgsProject = /** @class */ (function (_super) {
    ...
    function OfgsProject(obj) {
        ...
        if (obj) {
            ...
            if (obj.id) {
                ...
                _this._rs_form_ref = new ts_resource_tastypie_1.Tastypie.Resource(OrgFundGsFormRefSubscribe.resource.endpoint, { model: OrgFundGsFormRefSubscribe, defaults: { gs_project_id: obj.id } });
            }
        }
        else {
    ...
    Object.defineProperty(OfgsProject.prototype, "rs_form_ref", {
        get: function () {
