...
exports.OfgsProjectFinanceSchedule = exports.OfgsProjectComment = exports.OfgsProjectScore = exports.OfgsProjectView = exports.OfgsProject = exports.OfgsProjectMemberQuestion = exports.OfgsProjectMemberQuestionResp = exports.OrgFundGsFormSubscribe = exports.OfgsInvitationOng = exports.OrgGsMember = exports.OrgGsProduct = exports.OrgGsCategory = exports.OrgFundGs = void 0;
...
var OfgsProjectMemberQuestionResp = /** @class */ (function () {
    function OfgsProjectMemberQuestionResp(obj) {
        this.doador_id = null;
        this.stage_id = null;
        this.questions = [];
        if (obj) {
    ...
    return OfgsProjectMemberQuestionResp;
}());
exports.OfgsProjectMemberQuestionResp = OfgsProjectMemberQuestionResp;
var OfgsProjectMemberQuestion = /** @class */ (function () {
    function OfgsProjectMemberQuestion(obj) {
        this.members = [];
        this.member_resp = [];
        if (obj) {
            if (obj.members) {
                for (var _i = 0, _a = obj.members; _i < _a.length; _i++) {
                    var m = _a[_i];
                    this.members.push(new doador_1.Doador(m));
                }
            }
            if (obj.member_resp) {
                for (var _b = 0, _c = obj.member_resp; _b < _c.length; _b++) {
                    var mr = _c[_b];
    ...
    return OfgsProjectMemberQuestion;
}());
exports.OfgsProjectMemberQuestion = OfgsProjectMemberQuestion;
var OfgsProject = /** @class */ (function (_super) {
    ...
    OfgsProject.prototype.getStageMemberResponse = function () {
    ...
    OfgsProject.resource_get_member_resp = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo/gs-project/<id>/get-stage-member-response', { model: OfgsProjectMemberQuestion });
    OfgsProject.resource_set_member_resp = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo/gs-project/<id>/set-stage-member-response', { model: OfgsProjectMemberQuestionResp });
    return OfgsProject;
}(ts_resource_tastypie_1.Tastypie.Model));
