...
var OrgFundGs = /** @class */ (function (_super) {
    ...
    OrgFundGs.prototype.add_round = function (rounds) {
        ...
        if (this.id) {
            ...
            return doadorFundoGsRound_1.OrgFundGsRound.resource_add_round.objects.create(params).then(function (data) {
                var rounds = [];
    ...
    OrgFundGs.resource_get_member = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo-gs/gs/<id>/get-member');
    OrgFundGs.resource_add_member = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo-gs/gs/add-member');
    OrgFundGs.resource_delete_member = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo-gs/gs/<id>/delete-member');
