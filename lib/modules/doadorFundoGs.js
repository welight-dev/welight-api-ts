...
var OrgFundGs = /** @class */ (function (_super) {
    ...
    OrgFundGs.prototype._init = function (obj) {
        ...
        if (obj) {
            ...
            if (obj.id) {
                this._rs_member = new ts_resource_tastypie_1.Tastypie.Resource(OfgsMember.resource.endpoint, { model: OfgsMember, defaults: { gs_id: obj.id } });
            }
        }
    };
    Object.defineProperty(OrgFundGs.prototype, "rs_member", {
        get: function () {
    ...
    OrgFundGs.prototype.add_member = function (fund_members_id) {
        var _this = this;
        if (this.id) {
            return OrgFundGs.resource_add_member.objects.create({ gs_id: this.id, fund_members_id: fund_members_id }).then(function (data) {
    ...
    OrgFundGs.resource_add_member = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo-gs/gs/add-member');
