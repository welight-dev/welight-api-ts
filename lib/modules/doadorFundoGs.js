...
var OrgFundGsFormSubscribe = /** @class */ (function (_super) {
    ...
    OrgFundGsFormSubscribe.rs_init = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo/gs-form-subscribe/init-form', { model: OrgFundGsFormSubscribe });
...
var OfgsProject = /** @class */ (function (_super) {
    ...
    OfgsProject.resource_init_subscribe = new ts_resource_tastypie_1.Tastypie.Resource('doador-fundo/gs-form-subscribe/init-form', { model: OfgsProject });
