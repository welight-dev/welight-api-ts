...
exports.Metric = exports.MetricOds = exports.MetricUnitGroup = exports.MetricUnit = exports.MetricCategory = exports.MetricSubcategory = exports.MetricStandard = exports.Ods = void 0;
...
var MetricOds = /** @class */ (function () {
    function MetricOds(obj) {
        if (obj) {
            this.id = obj.id;
            if (obj.metric) {
...
var Metric = /** @class */ (function (_super) {
    ...
    function Metric(obj) {
        ...
        if (obj) {
            ...
            if (obj.metric_ods) {
                for (var _i = 0, _a = obj.metric_ods; _i < _a.length; _i++) {
                    var mo = _a[_i];
                    _this._metric_ods.push(new MetricOds(mo));
                }
            }
        }
        return _this;
    }
    Object.defineProperty(Metric.prototype, "standard", {
        get: function () {
    ...
    Object.defineProperty(Metric.prototype, "category", {
        get: function () {
    ...
    Object.defineProperty(Metric.prototype, "subcategory", {
        get: function () {
    ...
    Object.defineProperty(Metric.prototype, "unit_group", {
        get: function () {
    ...
    Object.defineProperty(Metric.prototype, "unit", {
        get: function () {
    ...
    Object.defineProperty(Metric.prototype, "ods", {
        get: function () {
