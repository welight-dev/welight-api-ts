...
var OngProjeto = /** @class */ (function (_super) {
    ...
    function OngProjeto(obj) {
        ...
        if (_this.id) {
            ...
            _this._entregas = new api.Tastypie.Resource('ong/projeto-entrega', { model: OngProjetoEntrega, defaults: { ong_projeto_id: _this.id } });
        }
        return _this;
    }
    ...
    Object.defineProperty(OngProjeto.prototype, "entregas", {
        get: function () {
