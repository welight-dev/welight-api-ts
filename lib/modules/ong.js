...
var OngTimeLine = /** @class */ (function (_super) {
    ...
    function OngTimeLine(obj) {
        ...
        if (obj) {
            if (obj.ong)
                _self.ong = new Ong(obj.ong);
            if (obj.projeto)
                _self.projeto = new OngProjeto(obj.projeto);
            if (obj.doacao_credito)
                _self.doacao_credito = new OngCarteira(obj.doacao_credito);
            if (obj.recurso)
                _self.recurso = new OngRecurso(obj.recurso);
        }
        return _this;
    }
...
var OngProjeto = /** @class */ (function (_super) {
    ...
    function OngProjeto(obj) {
        ...
        if (_this.id) {
            ...
            _this._recursos = new api.Tastypie.Resource('ong/recurso', { model: OngRecurso, defaults: { ong_projeto_id: _this.id } });
        }
        return _this;
    }
    ...
    Object.defineProperty(OngProjeto.prototype, "recursos", {
        get: function () {
            return this._recursos;
        },
        enumerable: true,
...
var OngOrigemCredito = /** @class */ (function () {
...
var OngRecursoDoacao = /** @class */ (function (_super) {
    ...
    function OngRecursoDoacao(obj) {
        return _super.call(this, OngRecursoDoacao.resource, obj) || this;
    }
