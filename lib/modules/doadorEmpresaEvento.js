...
var IngressoPublic = /** @class */ (function (_super) {
    ...
    IngressoPublic.prototype.gerar_fatura = function (cpf, email, qtde, convidados, ongs) {
        return this._gerar_fatura.objects.create({ ingresso_id: this.id, cpf: cpf, email: email, qtde: qtde, convidados: convidados, ongs: ongs }).then(function (data) {
            return new IngressoFatura(data);
        });
    };
