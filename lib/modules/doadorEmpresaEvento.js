...
var IngressoPublic = /** @class */ (function (_super) {
    ...
    IngressoPublic.prototype.gerar_fatura = function (nome, cpf, email, qtde, tipo_pagamento, convidados, ongs) {
        return this._gerar_fatura.objects.create({ ingresso_id: this.id, nome: nome, cpf: cpf, email: email, qtde: qtde, tipo_pagamento: tipo_pagamento, convidados: convidados, ongs: ongs }).then(function (data) {
            return new IngressoFatura(data);
        });
    };
