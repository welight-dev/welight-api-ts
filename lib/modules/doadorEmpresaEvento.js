...
exports.IngressoPublic = exports.Evento = exports.FaturaVip = exports.IngressoFaturaPagamento = exports.IngressoFaturaCliente = exports.IngressoFatura = exports.IngressoCupomFatura = exports.IngressoCupom = exports.ClienteVip = void 0;
...
var IngressoCupom = /** @class */ (function () {
    function IngressoCupom(obj) {
        if (obj) {
            this.id = obj.id;
            this.ingresso_id = obj.ingresso_id;
    ...
    return IngressoCupom;
}());
exports.IngressoCupom = IngressoCupom;
var IngressoCupomFatura = /** @class */ (function () {
    function IngressoCupomFatura(obj) {
        if (obj) {
            this.id = obj.id;
            ...
            this.dt_updated = obj.dt_updated;
            this.dt_created = obj.dt_created;
            if (obj.ingresso_cupom)
                this._ingresso_cupom = new IngressoCupom(obj.ingresso_cupom);
        }
    }
    Object.defineProperty(IngressoCupomFatura.prototype, "ingresso_cupom", {
        get: function () {
    ...
    return IngressoCupomFatura;
}());
exports.IngressoCupomFatura = IngressoCupomFatura;
...
var IngressoPublic = /** @class */ (function (_super) {
    ...
    function IngressoPublic(obj, _resource) {
        ...
        _this._check_cupom = new api.Tastypie.Resource('doador-empresa-evento/ingresso-public/check-cupom');
    ...
    IngressoPublic.prototype.gerar_fatura = function (nome, cpf, email, qtde, tipo_pagamento, convidados, ongs, desconto_id) {
        return this._gerar_fatura.objects.create({ ingresso_id: this.id, nome: nome, cpf: cpf, email: email, qtde: qtde, tipo_pagamento: tipo_pagamento, convidados: convidados, ongs: ongs, desconto_id: desconto_id }).then(function (data) {
            return new IngressoFatura(data);
        });
    };
    ...
    IngressoPublic.prototype.check_cupom = function (ingresso_id, codigo, qtde) {
        return this._check_cupom.objects.findOne({ ingresso_id: ingresso_id, codigo: codigo, qtde: qtde }).then(function (data) {
