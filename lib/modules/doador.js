...
var Doador = /** @class */ (function (_super) {
    ...
    function Doador(obj) {
        ...
        _this.plugin_navegador = new utils.PluginNavegador();
    ...
    Doador.prototype.initProfile = function (obj) {
        ...
        if (obj) {
            ...
            _self._doacao_mes = new api.Tastypie.Resource('doador/doacao-mes', { model: DoadorDoacaoMes, defaults: { doador_id: obj.id } });
    ...
    Doador.prototype.instalarPluginNavegador = function (navegador) {
        ...
        return new Promise(function (resolve, reject) {
            if (navegador == "chrome") {
                _self.plugin_navegador.instalarExtensaoChrome().then(function (success) {
                    _self.notificarPlugin().then(function (success) {
                        resolve(true);
                    });
                });
            }
            else if (navegador == "firefox") {
                _self.plugin_navegador.instalarExtensaoFirefox().then(function (success) {
                    _self.notificarPlugin().then(function (success) {
                        resolve(true);
                    });
                });
    ...
    Doador.prototype.notificarPlugin = function () {
        var _self = this;
        return _self.getDoacao().then(function (obj) {
            var wl_msg_profile = { user: _self._user.auth, doador: { nome: _self.nome, email: _self.email, impacto_total: obj.doador_doacao_impacto } };
