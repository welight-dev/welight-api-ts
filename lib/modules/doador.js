...
var Doador = /** @class */ (function (_super) {
    ...
    Doador.prototype.create_account = function (name, email, password, kargs) {
        var _self = this;
        return this._user.create_account(name, email, password, kargs).then(function (user) {
    ...
    Doador.prototype.login = function (username, password, kargs) {
        var _self = this;
        return this._user.login(username, password, kargs).then(function (user) {
            return _self._doador_logado.objects.findOne().then(function (data) {
                _self.initProfile(data);
                return _self;
            });
    ...
    Doador.prototype.login_facebook = function (username, facebook_uid, facebook_access_token, kargs) {
        var _self = this;
        return this._user.login_facebook(username, facebook_uid, facebook_access_token, kargs).then(function (user) {
            return _self._doador_logado.objects.findOne().then(function (data) {
                _self.initProfile(data);
                return _self;
            });
    ...
    Doador.prototype.quickLogin = function (auth, kargs) {
        var _self = this;
        return this._user.quickLogin(auth, kargs).then(function (user) {
            return _self._doador_logado.objects.findOne().then(function (data) {
                _self.initProfile(data);
                return _self;
            });
