...
var Produto = /** @class */ (function (_super) {
    ...
    function Produto(obj) {
        ...
        var _self = _this;
        if (_self.cat_tree) {
            var cat_tree = _self.cat_tree;
            _self.cat_tree = [];
            for (var _i = 0, cat_tree_1 = cat_tree; _i < cat_tree_1.length; _i++) {
                var obj_1 = cat_tree_1[_i];
                _self.cat_tree.push(new CategorySumary(obj_1));
            }
        }
        return _this;
    }
...
var Categoria = /** @class */ (function (_super) {
    ...
    function Categoria(obj) {
        ...
        if (_self.cat_tree) {
            var cat_tree = _self.cat_tree;
            _self.cat_tree = [];
            for (var _i = 0, cat_tree_2 = cat_tree; _i < cat_tree_2.length; _i++) {
                var obj_2 = cat_tree_2[_i];
                _self.cat_tree.push(new CategorySumary(obj_2));
            }
        }
        if (_self.filters) {
            ...
            for (var _a = 0, filters_1 = filters; _a < filters_1.length; _a++) {
                var obj_3 = filters_1[_a];
                var filter = new Filter(obj_3.name);
                filter.setOptions(obj_3.options);
...
var Comparador = /** @class */ (function () {
    function Comparador(defaults) {
        ...
        this.products_categories = new api.Tastypie.Resource('comparador/products-categories/search');
    }
        ...
        return _self.products.objects.find(data_params).then(function (page) {
            ...
            if (_self.categories.length === 0) {
                if ((!data_params.q || data_params.q === '') && (!params || Object.keys(params).length === 0)) {
                    _self.raiz = true;
                    _self.products_categories.objects.find({ level: 0 }).then(function (page_categories) {
                        for (var _i = 0, _a = page_categories.objects || []; _i < _a.length; _i++) {
                            var cat = _a[_i];
                            var cat_filter = new CategoryFilters(cat.id, cat.name, cat.doc_count);
                            cat_filter.setCatTree(cat.cat_tree);
                            cat_filter.setFilters(cat.filters);
