...
var Comparador = /** @class */ (function () {
    ...
    Comparador.prototype.search = function (q) {
        var _self = this;
        _self.categories = [];
        _self.category_selected = null;
        _self._filters_selected = [];
        _self.query_string = q;
        return _self.products.objects.find({ q: q }).then(function (page) {
    ...
    Comparador.prototype.filter = function () {
        ...
        return _self.products.objects.find(data).then(function (page) {
            return _self;
        });
    };
