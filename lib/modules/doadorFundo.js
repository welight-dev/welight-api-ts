...
var Org = /** @class */ (function (_super) {
    ...
    function Org(obj) {
        ...
        if (obj.activity) {
            ...
            _this.activity = new OrgActivity();
        }
        if (obj.id) {
            _this._adm = new ts_resource_tastypie_1.Tastypie.Resource(OrgAdm.resource.endpoint, { model: OrgAdm, defaults: { org_id: obj.id } });
        }
        _this._activity = new ts_resource_tastypie_1.Tastypie.Resource(OrgActivity.resource.endpoint, { model: OrgActivity, defaults: { org_id: obj.id || 0 } });
        return _this;
    }
