...
var OrgFund = /** @class */ (function (_super) {
    ...
    function OrgFund(obj) {
        ...
        if (obj && obj.id) {
            _this._rs_balance = new ts_resource_tastypie_1.Tastypie.Resource(OrgFundBalance.resource.endpoint, { model: OrgFundBalance, defaults: { org_fund_id: obj.id } });
            _this._rs_member = new ts_resource_tastypie_1.Tastypie.Resource(OrgFundMember.resource.endpoint, { model: OrgFundMember, defaults: { org_fund_id: obj.id } });
            _this._rs_category = new ts_resource_tastypie_1.Tastypie.Resource(OrgFundCategory.resource.endpoint, { model: OrgFundCategory, defaults: { org_fund_id: obj.id } });
        }
        if (!_this.summary) {
            _this.summary = {
