    ...
    Empresa.prototype.initProfile = function (obj) {
        if (obj) {
            if (obj.id) {
                ...
                this._modulos = new api.Tastypie.Resource('doador-empresa/modulo', { model: EmpresaModuloAtivo, defaults: { empresa_id: obj.id } });
            }
...
var EmpresaModuloAtivo = /** @class */ (function (_super) {
    ...
    EmpresaModuloAtivo.resource = new api.Tastypie.Resource('doador-empresa/modulo', { model: EmpresaModuloAtivo });
