...
var Empresa = /** @class */ (function (_super) {
    ...
    Empresa.prototype.getVtex = function () {
        var _self = this;
        if (_self.id) {
            return EmpresaVtex.resource.objects.findOne({ empresa_id: _self.id }).then(function (data) {
                _self.vtex = data;
                return data;
            });
        }
    ...
    Empresa.prototype.getVtexConf = function () {
        if (this.id) {
...
var VtexIconChoices = /** @class */ (function (_super) {
    __extends(VtexIconChoices, _super);
    function VtexIconChoices(obj) {
        return _super.call(this, VtexIconChoices.resource, obj) || this;
    }
    VtexIconChoices.resource = new api.Tastypie.Resource('doador-empresa/vtex-icon-choices', { model: VtexIconChoices });
    return VtexIconChoices;
}(api.Tastypie.Model));
exports.VtexIconChoices = VtexIconChoices;
var EmpresaVtex = /** @class */ (function (_super) {
    __extends(EmpresaVtex, _super);
    function EmpresaVtex(obj) {
        return _super.call(this, EmpresaVtex.resource, obj) || this;
    }
