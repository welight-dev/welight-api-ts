...
exports.EmpresaPdv = exports.EmpresaHotmart = exports.EmpresaSignaShop = exports.EmpresaOpenCart = exports.EmpresaVirtueMart = exports.EmpresaMagento = exports.EmpresaPrestaShop = exports.EmpresaIluria = exports.EmpresaMercadoShops = exports.EmpresaNuvemShop = exports.EmpresaXtech = exports.Empresa3dCart = exports.EmpresaVolusion = exports.EmpresaBigcommerce = exports.EmpresaShopify = exports.EmpresaLojaintegrada = exports.EmpresaVnda = exports.EmpresaVtex = exports.EmpresaWidget = exports.WidgetIconChoices = exports.VendaAnalytics = exports.EmpresaOngTelaResposta = exports.ClienteTelaResposta = exports.EmpresaTelaResposta = exports.ClienteVendaOng = exports.Venda = exports.Cliente = exports.ClienteOng = exports.EmpresaOngPublic = exports.EmpresaOng = exports.EmpresaEndereco = exports.EmpresaDetail = exports.EmpresaModuloAtivo = exports.EmpresaModuloPlataforma = exports.EmpresaModulo = exports.EmpresaProduto = exports.Empresa = void 0;
...
var Empresa = /** @class */ (function (_super) {
    ...
    Empresa.prototype.getEndereco = function () {
        if (this.id) {
            return EmpresaEndereco.resource.objects.findOne({ empresa_id: this.id }).then(function (data) {
                return data;
            });
        }
        else {
    ...
    Empresa.prototype.createAccount = function (nome, email, cpf_cnpj, kwargs) {
        ...
        return this._doador.createAccountDoadorEmpresa(nome, email, cpf_cnpj, kwargs).then(function (doador_response) {
            return Empresa.resource.objects.get(doador_response.user.current_user_app.app_profile_id).then(function (empresa_resp) {
                if (empresa_resp.id) {
...
var EmpresaProduto = /** @class */ (function (_super) {
    __extends(EmpresaProduto, _super);
    function EmpresaProduto(obj) {
        var _this = _super.call(this, EmpresaProduto.resource, obj) || this;
        _this.modulos = [];
        if (obj) {
            if (obj.modulos) {
                for (var _i = 0, _a = obj.modulos; _i < _a.length; _i++) {
                    var modulo = _a[_i];
                    _this.modulos.push(new EmpresaModulo(modulo));
                }
            }
        }
        return _this;
    }
    EmpresaProduto.resource = new api.Tastypie.Resource('doador-empresa/produto', { model: EmpresaProduto });
    return EmpresaProduto;
}(api.Tastypie.Model));
exports.EmpresaProduto = EmpresaProduto;
var EmpresaModulo = /** @class */ (function (_super) {
    ...
    function EmpresaModulo(obj) {
        ...
        if (obj) {
            if (obj.produto)
                _this.produto = new EmpresaProduto(obj.produto);
            if (obj.plataformas) {
...
var EmpresaWidget = /** @class */ (function (_super) {
    ...
    function EmpresaWidget(obj, resource) {
        var _this = _super.call(this, resource || EmpresaWidget.resource, obj) || this;
        if (obj) {
            if (obj.empresa)
                _this.empresa = new Empresa(obj.empresa);
        }
    ...
    EmpresaWidget.resource = new api.Tastypie.Resource('doador-empresa/venda/widget-config', { model: EmpresaWidget });
...
var EmpresaHotmart = /** @class */ (function (_super) {
    __extends(EmpresaHotmart, _super);
    function EmpresaHotmart(obj) {
        return _super.call(this, obj, EmpresaHotmart.resource) || this;
    }
    EmpresaHotmart.resource = new api.Tastypie.Resource('doador-empresa/hotmart', { model: EmpresaHotmart });
    return EmpresaHotmart;
}(EmpresaWidget));
exports.EmpresaHotmart = EmpresaHotmart;
