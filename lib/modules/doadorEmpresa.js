...
var doador_models = require("./doador");
...
var Empresa = /** @class */ (function (_super) {
    ...
    function Empresa(obj) {
        ...
        _this._doador = new doador_models.Doador();
    ...
    Empresa.prototype.login = function (username, password) {
        var _self = this;
        return this._doador.login(username, password).then(function (doador_response) {
    ...
    Empresa.prototype.quickLogin = function (username, apikey) {
        var _self = this;
        return this._doador.quickLogin({ username: username, apikey: apikey }).then(function (doador_response) {
            return Empresa.resource.objects.findOne({ doador_id: doador_response.id }).then(function (empresa_resp) {
                if (empresa_resp.id) {
                    _self.setData(empresa_resp);
                    _self.initProfile(empresa_resp);
...
var EmpresaOng = /** @class */ (function (_super) {
    ...
    function EmpresaOng(obj, _resource) {
        ...
        if (obj) {
            if (obj.ong)
                _this.ong = new ong_models.Ong(obj.ong);
        }
        return _this;
    }
