...
exports.UserAddress = exports.UserAccount = exports.User = exports.UserBar = exports.UserApp = exports.AppPermission = exports.App = exports.Auth = void 0;
...
var App = /** @class */ (function (_super) {
    ...
    function App(obj) {
        var _this = _super.call(this, App.resource, obj) || this;
        _this.permissions = [];
        if (obj && obj.permissions) {
            for (var _i = 0, _a = obj.permissions; _i < _a.length; _i++) {
                var perm = _a[_i];
                _this.permissions.push(new AppPermission(perm));
            }
        }
        return _this;
    }
    App.resource = new ts_resource_tastypie_1.Tastypie.Resource('we-auth/app', { model: App });
    return App;
...
var AppPermission = /** @class */ (function () {
    ...
    Object.defineProperty(AppPermission.prototype, "id", {
        get: function () {
            return this._id;
        },
        enumerable: false,
...
var UserApp = /** @class */ (function () {
    function UserApp(id, app_name, app_token, app_profile_id, display_name, avatar, admin, permissions) {
        this._id = id;
    ...
    Object.defineProperty(UserApp.prototype, "avatar", {
        get: function () {
            return this._avatar;
        },
        enumerable: false,
...
var UserBar = /** @class */ (function () {
    ...
    UserBar.prototype._set_available = function () {
        this._app_available.push(new UserApp(0, 'NGO', 'ong', 0, 'NGO', '', false, []));
    ...
    UserBar.prototype.remove_app = function (obj) {
        if (obj.admin) {
            for (var i = 0; i < this._app_admin.length; i++) {
            ...
            for (var i = 0; i < this._app_shared.length; i++) {
...
var User = /** @class */ (function () {
    ...
    User.prototype.select_profile = function (user_app) {
    ...
    Object.defineProperty(User.prototype, "hidden_login", {
        get: function () {
    ...
    User.prototype.setProfile = function (data, kwargs) {
        ...
        if (data &&
            ...
            for (var _i = 0, _a = data.apps; _i < _a.length; _i++) {
                var userapp = _a[_i];
                var obj_userapp = new UserApp(userapp.id, userapp.app_name, userapp.app_token, userapp.app_profile_id, userapp.display_name, userapp.avatar, userapp.admin, userapp.permissions);
    ...
    User.prototype.change_language = function (code) {
        var _this = this;
        if (this._is_authenticated) {
            return UserAccount.resource.objects.update(this.id, { account: { idioma: code } }).then(function () {
                _this._account.idioma = code;
                return _this;
            }).catch(function () {
                _this._account.idioma = code;
                return _this;
