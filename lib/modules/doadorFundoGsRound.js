...
var OfgsStage = /** @class */ (function (_super) {
        ...
        if (obj) {
            ...
            if (obj.questions) {
                for (var _b = 0, _c = obj.questions; _b < _c.length; _b++) {
                    var qt = _c[_b];
                    _this._questions.push(new doadorFundoGsQuiz_1.StageMemberQuestionTemplate(qt));
                }
            }
        }
        return _this;
    }
    OfgsStage.prototype.save = function (obj) {
        if (!obj) {
            obj = {};
        }
        obj['evaluators'] = [];
        ...
        return _super.prototype.save.call(this, obj);
    };
    ...
    OfgsStage.prototype.select_members = function (tokens) {
        var _loop_1 = function (token) {
            ...
            this_1._member_manager.select_members(tokens);
        };
        var this_1 = this;
